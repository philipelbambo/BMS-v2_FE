    ...
    },
    {
        ...
        type: 'Double',
        price: '₱2,600',
        pricePerMonth: '₱2,600/person/month',
        images: [
        'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?w=800&h=600&fit=crop',
        'https://images.unsplash.com/photo-1540518614846-7eded433c457?w=800&h=600&fit=crop',
        'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?w=800&h=600&fit=crop',
        ],
        amenities: ['Wi-Fi', 'Fan', 'Shared Bathroom', '2 Study Desks', '2 Beds', 'Window'],
        size: '17 sqm',
        availability: 'Available',
        description: 'Comfortable double occupancy room with good ventilation. Perfect for roommates who prefer a budget-friendly option.'
    },
    {
        id: 8,
        title: 'Room 8',
        ...
        amenities: ['Wi-Fi', 'Air Conditioning', 'Shared Bathroom', 'Study Desk', 'Bed', 'Closet'],
        size: '11 sqm',
        availability: 'Available',
        description: 'Cozy single room with air conditioning and ample storage space. Great for students who prioritize comfort.'
    },
    {
        id: 9,
        title: 'Room 9',
        ...
        size: '11 sqm',
        availability: 'Available',
        description: 'Simple and affordable single room with all the essentials. Perfect for students on a tight budget.'
    },
    {
        id: 10,
        title: 'Room 10',
        type: 'Double',
        price: '₱2,700',
        pricePerMonth: '₱2,700/person/month',
        images: [
        'https://images.unsplash.com/photo-1595526114035-0d45ed16cfbf?w=800&h=600&fit=crop',
        'https://images.unsplash.com/photo-1611892440504-42a792e24d32?w=800&h=600&fit=crop',
        'https://images.unsplash.com/photo-1540518614846-7eded433c457?w=800&h=600&fit=crop',
        ],
        amenities: ['Wi-Fi', 'Fan', 'Shared Bathroom', '2 Study Desks', '2 Beds', 'Balcony'],
        size: '18 sqm',
        availability: 'Available',
        description: 'Spacious double room with balcony access. Ideal for roommates who enjoy fresh air and natural light.'
    },
    {
        id: 11,
        title: 'Apartment 1',
    ...
    // Get room ID from URL (you can use URL params or state)
    ...
    return (
        ...
        <div className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 py-6">
            ...
            <button 
                ...
                className="flex items-center text-[#001F3D] font-bold hover:text-[#003566] transition-colors"
            >
            ...
            <div className="flex items-center gap-4">
                ...
                disabled={currentRoomId === 1}
                className={`p-2 rounded transition-all ${
                    currentRoomId === 1 
                    ? 'bg-gray-200 text-gray-400 cursor-not-allowed' 
                    : 'bg-[#001F3D] text-white hover:bg-[#003566]'
                }`}
                >
        ...
        {/* Room Detail Section */}
        <main className="max-w-[1600px] mx-auto px-4 sm:px-8 lg:px-12 pb-16">
            {/* Image Gallery */}
            <div className="relative bg-white rounded shadow-xl overflow-hidden mb-8">
            ...
            <button
                onClick={prevImage}
                className="absolute left-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-[#001F3D] text-gray-900 hover:text-white p-3 rounded shadow-lg transition-all"
            >
                <ChevronLeft className="w-6 h-6" />
            </button>
            <button
                onClick={nextImage}
                className="absolute right-4 top-1/2 -translate-y-1/2 bg-white/80 hover:bg-[#001F3D] text-gray-900 hover:text-white p-3 rounded shadow-lg transition-all"
            >
            ...
            <div className="absolute bottom-4 left-1/2 transform -translate-x-1/2 flex gap-2">
                ...
                <button
                    ...
                    className={`w-3 h-3 rounded transition-all ${currentImageIndex === idx ? 'bg-white w-8' : 'bg-white/50'}`}
            ...
            {/* Room Type Tag */}
            <div className="absolute top-4 left-4 bg-[#001F3D] text-white px-4 py-2 rounded shadow-md">
            ...
            {/* Specs */}
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-8 p-6 bg-gray-50 rounded">
                <div>
            ...
            <div className="mb-10">
                ...
                {room.amenities.map((amenity, idx) => (
                    <div key={idx} className="flex items-center gap-2 bg-gray-50 px-4 py-3 rounded">
            ...
            <div className="border-t border-gray-200 mt-8 pt-8">
                ...
                <button
                    ...
                    currentRoomId === 1
                        ? 'bg-gray-200 text-gray-400 cursor-not-allowed'
                        : 'bg-gray-100 text-[#001F3D] hover:bg-gray-200'
                    }`}
                >
                    <ChevronLeft className="w-5 h-5" />
                    Previous Room
